...
import com.hujian.trident.ml.classifier.Winnow.ModifyBalancedWinnowClassifier;
 ...
 */
public class ModifyBalancedWinnowTopology {
        ...
        TridentState tridentState = tridentTopology
                ...
                .partitionPersist(new MemoryMapState.Factory(),new Fields("instance"),
                        new ClassifierModelUpdate("b-winnow",
                                new ModifyBalancedWinnowClassifier()));
