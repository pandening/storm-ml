 ...
 */
public class HybridClassifierSpout implements IBatchSpout {
     ...
     * @param bitchSize
     */
    public HybridClassifierSpout( String dataSourcePath ,Integer bitchSize){
     ...
     * @param dataSourcePath
     */
    public HybridClassifierSpout( String dataSourcePath ){
        this.dataSourcePath =dataSourcePath;
    }
    ...
    public Fields getOutputFields() {
        ...
        String[] fieldNames = new String[30];
        fieldNames[0] = "id";
        fieldNames[1] = "label";
        /**
         * start from x1.....
